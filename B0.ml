...
let default =
  let meta =
    ...
    |> ~~ B0_meta.homepage "https://erratique.ch/software/webbrowser"
    |> ~~ B0_meta.online_doc "https://erratique.ch/software/webbrowser/doc/"
    |> ~~ B0_meta.licenses ["ISC"]
    |> ~~ B0_meta.repo "git+https://erratique.ch/repos/webbrowser.git"
    |> ~~ B0_meta.issues "https://github.com/dbuenzli/webbrowser/issues"
  ...
  in
  B0_pack.make "default" ~doc:"webbrowser package" ~meta ~locked:true @@
  B0_unit.list ()
